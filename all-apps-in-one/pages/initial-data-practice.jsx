...
/**
 * Fetch a list of labels from the
 * `https://ui.dev/api/courses/react-query/labels`
 * endpoint and render them in a list.
 * You can optionally style them with the label's color.
 *
 * Use the provided static labels as initial data.
 */
